  ...
  return (
    <>
      ...
      <div className="container mx-auto my-8 p-4">
        ...
        <p>
          Refunds are not available in the case that Cauchy Math believes the student is not actively trying to improve (not completing homework, academic dishonesty). We will inform the student's parent/guardian in this case.
        </p>
        <p className="mt-4">
