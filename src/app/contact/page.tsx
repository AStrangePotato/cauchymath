...
const ContactPage = () => {
  return (
    <div className="mt-12">
      <Breadcrumb pageName="Contact Page" description="Cauchy Math offers a free assessment class available for first-time students, where we will work out your goals and prepare an expert plan to help you succeed." />
      <Contact />
    </div>
  );
};
