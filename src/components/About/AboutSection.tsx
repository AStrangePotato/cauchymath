...
const AboutSectionOne = () => {
  const List = ({ text }) => (
    <p className="mb-5 flex items-center text-lg font-medium text-body-color">
      <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-emerald-300">
        {checkIcon}
      </span>
      {text}
    </p>
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  ...
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Contest Preparation" />
                    <List text="Flexible Scheduling" />
                    <List text="Proven Results" />
                  </div>
                </div>
              </div>
            </div>
