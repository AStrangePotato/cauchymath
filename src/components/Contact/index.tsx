...
const Contact = () => {
  ...
  return (
    <section id="contact" className="overflow-hidden py-12 md:py-18 lg:py-2">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="I would like to sign up for a class, are you available Friday next week at 6pm?"
