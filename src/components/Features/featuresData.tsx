...
const featuresData: Feature[] = [
  ...
  },
  {
    id: 1,
    icon: (
      <svg width="80" height="80" viewBox="0 0 80 80" className="fill-current">
        <path
          d="M15 55 L30 40 L45 45 L60 25"
          stroke="currentColor"
          strokeWidth="3"
          fill="none"
        />
    ...
    paragraph:
      "We are so confident in our teachings that if your grade doesn't improve, we will offer a full refund!",
  },
];
